...
public:
    ...
    virtual vector<complex<double > > FFT2D(vector<complex<double> >input, unsigned int width, unsigned int height) = 0;

    virtual vector<complex<double> > FFT2D_Inverse(vector<complex<double> > input, unsigned int width, unsigned int height, bool flip = false) = 0;
